...
import net.darkz70.featherplugin.core.manager.neoforge.NeoForgeManager;
...
public class ForgeLoaderManager implements LoaderManager {
	...
	@Override
	public Configuration registerCustomConfiguration(@NotNull FeatherProjectConfigurationData data, String name, String originalName, String loaderName) {
		Project project = data.project();
