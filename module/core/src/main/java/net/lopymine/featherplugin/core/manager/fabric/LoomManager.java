package net.lopymine.featherplugin.core.manager.fabric;
...
public class LoomManager {
	...
	public static void apply(@NotNull FeatherProjectConfigurationData data, LoomGradleExtensionAPI loom) {
