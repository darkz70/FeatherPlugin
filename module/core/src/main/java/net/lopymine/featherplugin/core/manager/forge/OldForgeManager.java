package net.lopymine.featherplugin.core.manager.forge;
...
//
//	public static void apply(@NotNull FeatherProjectConfigurationData data, FeatherCoreDependenciesExtension extension) {
